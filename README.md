# Rollbar notifier for Python [![Build Status](https://travis-ci.org/rollbar/pyrollbar.png?branch=v0.9.6)](https://travis-ci.org/rollbar/pyrollbar) [![codecov.io](https://codecov.io/github/rollbar/pyrollbar/coverage.svg?branch=v0.9.6)](https://codecov.io/github/rollbar/pyrollbar?branch=v0.9.6)
